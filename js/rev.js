...
let fullMsg = '';
var grammarBtn = document.querySelector('button#checkGrammar')
...
function doStream() {
    ...
    //REV.AI ACCESS TOKEN
    const access_token = '026nJVnCC6QYB0NI4aiSTa2aZgaZPh2TA89YcZ8LknZy6Sc-_bAjfMLjsAaKPTPiR0zgZbHo4GQTiKoCWlHxpsKNu8xd8';
...
//     var params = {
//         language: "en-US", // This is required!  Language code
//         text: 'hello my name are john', // This is required too! Text to be checked
//     };

//     languageTool.check(params, function (err, result) {
//         if (err) {
//             console.log(err);
//         } else {
//             console.log(result);
